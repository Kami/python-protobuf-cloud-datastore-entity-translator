...
class ExampleWithReferencedTypeDBModel(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"referenced_type_key"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"referenced_enum",u"referenced_type_key",u"string_key"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"referenced_type_key",b"referenced_type_key"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"referenced_enum",b"referenced_type_key",b"string_key"]) -> None: ...
